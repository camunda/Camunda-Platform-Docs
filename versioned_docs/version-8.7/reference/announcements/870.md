...
## Keycloak support upgraded to v25 and v26

Identity 8.7 supports Keycloak v25 and v26.

### Increase container resources

Keycloak containers require an increase in resources from the default, in the Camunda helm charts the values are set to:
...
As we repackage the Bitnami distribution with our Identity login page insecured images must be set to true, this is handled in the helm chart with:
